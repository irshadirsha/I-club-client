      ...
      <div className=" max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className={`${showNavbar ? 'block' : 'hidden'} w-full md:block md:w-auto`} id="navbar-dropdown">
          <ul className="z-10 flex flex-col font-medium p-4 md:pr-16 md:p-0 mt-4 border border-gray-100 rounded-lg bg-white md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white ">
            ...
            {/* <li>
                <NavLink to='/club-list' className="block py-2  pl-3 pr-4 bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent" aria-current="page" exact>
                  clubs
                </NavLink>
              </li> */}
              <li>
                <NavLink to='/' className="block py-2  pl-3 pr-4 bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent" aria-current="page" exact>
                  Home
                </NavLink>
              </li>
                <li>
                <NavLink to='/club-list' className="block py-2 pl-3 pr-4 text-gray-900 rounded md:border-0 md:hover:text-blue-700 md:p-0  "exact>
                  Clubs
                  </NavLink>
              </li>
              <li>
                <NavLink to='/about' className="block py-2 pl-3 pr-4 text-gray-900 rounded md:border-0 md:hover:text-blue-700 md:p-0  "exact>
                  About
                  </NavLink>
              </li>
              {user ? (<li>
          ...
          <li>
            ...
            <li>
              ...
              Logout
                ...
                <>
              <li>
                <NavLink to='/login' className="block py-2 pl-3 pr-4 text-gray-900 rounded  md:border-0 md:hover:text-blue-700 md:p-0" exact>
                  Login
                </NavLink>
              </li>
              <li>

                <NavLink to='/signup' className="block py-2 pl-3 pr-4 text-gray-900 rounded  md:border-0 md:hover:text-blue-700 md:p-0" exact>
                  SignIn
                </NavLink>
              </li>
