...
const fetchdata=async()=>{  
  ...
  return (
    ...
    <div className=" sm:justify-center items-center justify-evenly py-4 px-8 flex flex-col md:flex-row space-y-4 md:mx-32 md:space-x-4">
      {/* President Card */}
      <div className=" relative flex w-full md:w-96 mt-4 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
        <div className="relative mx-4 mt-4 h-44 md:h-56 overflow-hidden rounded-xl  bg-clip-border text-gray-700 shadow-lg">
          <div className="rounded-3xl overflow-hidden">
            <img
              src={authority?.president?.image || "https://media.istockphoto.com/id/1337144146/vector/default-avatar-profile-icon-vector.jpg?s=612x612&w=0&k=20&c=BIbFwuv7FxTWvh5S3vB6bkT0Qv8Vn8N5Ffseq84ClGI="}
              alt="profile-picture"
      ...
      <div className=" relative flex w-full md:w-96 mt-4 flex-col rounded-xl bg-white  bg-clip-border text-gray-700 shadow-md">
        <div className="relative mx-4 mt-4 h-44 md:h-56 overflow-hidden rounded-xl bg-clip-border text-gray-700 shadow-lg">
          <div className="rounded-3xl overflow-hidden">
            <img
              src={authority?.secretory?.image || "https://media.istockphoto.com/id/1337144146/vector/default-avatar-profile-icon-vector.jpg?s=612x612&w=0&k=20&c=BIbFwuv7FxTWvh5S3vB6bkT0Qv8Vn8N5Ffseq84ClGI="}
              alt="profile-picture"
              className="w-full h-full object-cover"
            />
          </div>
      ...
      <div className=" relative flex w-full md:w-96 mt-4 flex-col rounded-xl bg-white  bg-clip-border text-gray-700 shadow-md">
        <div className="relative mx-4 mt-4 h-44 md:h-56 overflow-hidden rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
          <div className="rounded-3xl overflow-hidden">
            <img
              src={authority?.treasurer?.image || "https://media.istockphoto.com/id/1337144146/vector/default-avatar-profile-icon-vector.jpg?s=612x612&w=0&k=20&c=BIbFwuv7FxTWvh5S3vB6bkT0Qv8Vn8N5Ffseq84ClGI="}
              alt="profile-picture"
              className="w-full h-full object-cover"
            />
          </div>
...
//     <div className=''>
//          {loading && <Loader/>}
//       <div className="bg-gray-300 sm:justify-center items-center  justify-evenly py-4 px-8 flex flex-col md:flex-row space-y-4 md:mx-32 md:space-x-4">
//         {/* President Card */}
//         <div className=" bg-green-200 relative flex w-96 mt-4 flex-col rounded-xl  bg-clip-border text-gray-700 shadow-md">
